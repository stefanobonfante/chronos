...
public class StimeTest {
  ...
  @InjectMocks public StimeService service;

  @Mock public StimeRrepository stimeRrepository;

  @Mock public StimeMapper mapper;
  ...
  public void testRecuperoTask() throws EsecuzioneErrataException {
    ...
    when(mapper.FromEntityToProjection(listaStimeEntity.get(0)))
        .thenReturn(dammiUnaListaProjection().get(0));
  ...
  public void testGetTaskFailed() throws EsecuzioneErrataException {
    ...
    assertThatThrownBy(() -> service.recuperoTask("a"))
  ...
  public void testRecuperoSubTask() throws EsecuzioneErrataException {
    ...
    // Configura il comportamento simulato del mapper
    when(mapper.FromEntityToProjectionSubTask(listaStimeEntity.get(0)))
        .thenReturn(dammiUnaListaProjectionSubTask().get(0));
    // Chiama il metodo da testare
  ...
  public void testGetSubTaskFailed() throws EsecuzioneErrataException {
    ...
    assertThatThrownBy(() -> service.recuperoSubTask("a", "a"))
        .isInstanceOf(EsecuzioneErrataException.class);
  }
